...
export type AuthActionType = 'RESTORE_TOKEN' | 'SIGN_IN_START' | 'SIGN_IN_SUCCESS' | 'SIGN_OUT' | 'SIGN_UP_START' | 'SIGN_UP_COMPLETE';
...
export default function Main({ colorScheme }: MainProps) {
  ...
  const authContext = React.useMemo(
    () => ({
      ...
      signUpStart: () => {
        dispatch({ type: 'SIGN_UP_START', loggedUser: null })
      },
