            ...
            <ScrollView style={styles.scrollPanel}>
                <View style={{ ...styles.form, ...style }}>
                    ...
                    <View style={styles.buttons}>
                        <TurboButton buttonSize={20} backgroundColor="green" color="white" onPress={this.handleSubmit} name='check-circle' >
                            Submit
                        </TurboButton>
                        <TurboButton buttonSize={20} backgroundColor="#ff4466" color="white" onPress={this.reset} name='times-circle' >
                            Reset
                        </TurboButton>
                        <TurboButton buttonSize={20} backgroundColor="gray" color="white" onPress={this.props.onCancel} name='times-circle' >
                            Cancel
                        </TurboButton>
                    </View>
                </View>
