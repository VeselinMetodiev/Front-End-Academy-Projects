            ...
            <View style={styles.itemContainer}>
                <View style={styles.postItem}>
                    ...
                    <View style={styles.postItemButtons}>
                        <TurboButton style={styles.button} textStyle={styles.buttonText} name="pencil-square" buttonSize={27} color="white" backgroundColor='green'
                            onPress={() => onEdit(post)}>Edit
                        </TurboButton>
                        <View style={{ width: 20, backgroundColor: 'transparent' }}></View>
                        <TurboButton style={styles.button} textStyle={styles.buttonText} name="times-circle" buttonSize={27} color="white" backgroundColor='#ff4466'
