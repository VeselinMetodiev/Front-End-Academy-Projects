import React, { Component, Fragment, JSXElementConstructor, ReactElement, ReactNode, useCallback } from 'react';
...
class TodoInput extends Component<TodoInputProps, TodoInputState> {
    ...
    handleTodoSubmit = (event: React.FormEvent) => {
        ...
        this.props.onCreateTodo(new Todo(this.state.text, new Date(this.state.deadline).toDateString(), TodoStatus.Active, + this.state.id));
        this.setState({text: ''})
    }
